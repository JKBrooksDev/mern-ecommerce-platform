...
export const selectAddress=(state)=>state.AddressSlice.addresses
...
export const selectAddressDeleteStatus=(state)=>state.AddressSlice.addessDeleteStatus
export const selectAddressUpdateStatus=(state)=>state.AddressSlice.addressUpdateStatus

//exporting reducers
export const
{resetAddressStatus, resetAddressAddStatus, resetStatus, resetAddressDeleteStatus, resetAddressUpdateStatus}=addressSlice.actions
